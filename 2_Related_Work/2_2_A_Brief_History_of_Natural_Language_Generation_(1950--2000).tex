\section{A Brief History of Natural Language Generation (1950-2000)}
...
%For example, MT, text simplification, and text
%summarization are all considered text-to-text generation when the approach
%uses aligned sentence in input and output languages, pairs of complex and
%simple sentences with similar meaning, and document/summary pairs
%respectively.
