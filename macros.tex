% Shortcut for chapter intro block quoting.
\newcommand{\introquote}[2]{
    \begin{verse}
        #1
        \attrib{#2}
    \end{verse}
...
% Intro paragraph starting glyph
\newcommand{\startglyph}{
    \colorbox{black}{\makebox(3,6){\textcolor{white}{>>}}}
}
...
\newcommand{\docstream}{\ensuremath{\mathcal{D}}}
\newcommand{\snuggets}{\ensuremath{\mathcal{N}}}
\newcommand{\docstreamq}{\ensuremath{\docstream^{(\query)}}}
\newcommand{\sentstream}{\ensuremath{\mathcal{S}}}
\newcommand{\sentstreamq}{\ensuremath{\mathcal{X}^{(\query)}}}
\newcommand{\sdoc}{\ensuremath{d}}
\newcommand{\ssent}{\ensuremath{s}}
\newcommand{\ssize}{\ensuremath{{m^{(\docstream)}}}}
\newcommand{\sssize}{\ensuremath{{m^{(\sentstream)}}}}
\newcommand{\dssize}{\ensuremath{n}}
\newcommand{\ts}{\ensuremath{\tau}}
\newcommand{\docts}{\ensuremath{\tau^{(\docstream)}}}
\newcommand{\sentts}{\ensuremath{\tau^{(\sentstream)}}}
\newcommand{\uts}{\ensuremath{\tau^{(\updateSummary)}}}
\newcommand{\nts}{\ensuremath{\tau^{(\snuggets)}}}
\newcommand{\systs}{\ensuremath{\hat{\tau}}}
\newcommand{\sact}{\ensuremath{y}}
\newcommand{\supdate}{\ensuremath{u}}
\newcommand{\snugget}{\ensuremath{\gamma}}
\newcommand{\nsize}{\ensuremath{r}}
\newcommand{\utuple}[1]{\ensuremath{\left(\supdate_{#1},\uts_{#1}\right)}}
\newcommand{\ntuple}[1]{\ensuremath{\left(\snugget_{#1},\nts_{#1}\right)}}
\newcommand{\nEG}{\ensuremath{n\mathbb{E}[\gain]}}
\newcommand{\EG}{\ensuremath{\mathbb{E}[\gain]}}
\newcommand{\harm}{\ensuremath{\mathcal{H}}}
\newcommand{\poestart}{\ensuremath{\ts_\starttok}}
\newcommand{\poestop}{\ensuremath{\ts_\stoptok}}
\newcommand{\dhour}{\ensuremath{\delta_{hour}}}
\newcommand{\featf}[1]{\ensuremath{\phi\left(#1\right)}}
\newcommand{\latf}[1]{\ensuremath{\psi\left(#1\right)}}
\newcommand{\salmodf}[1]{\ensuremath{f\left(#1\right)}}
\newcommand{\Exemplars}{\ensuremath{\mathcal{E}}}
\newcommand{\spredsals}{\ensuremath{\boldsymbol{\hat{\mathbf{y}}}}}
\newcommand{\spredsal}{\ensuremath{\hat{y}}}


\newcommand{\spredacts}{\ensuremath{\boldsymbol{\hat{\mathbf{y}}}}}
\newcommand{\tmo}{\ensuremath{{t-1}}}
\newcommand{\salop}[1]{\ensuremath{\operatorname{salience}\left(#1\right)}}
\newcommand{\simop}[1]{\ensuremath{\operatorname{similarity}\left(#1\right)}}
\newcommand{\cossim}[1]{\ensuremath{\operatorname{cosine-similarity}\left(#1\right)}}
\newcommand{\sdimw}{\ensuremath{{D_w}}}
\newcommand{\sdims}{\ensuremath{{D_s}}}
\newcommand{\sdiml}{\ensuremath{{D_h}}}
\newcommand{\tsmat}{\ensuremath{\mathbf{K}}}
\newcommand{\wmat}{\ensuremath{\mathbf{W}}}
\newcommand{\wproj}{\ensuremath{\mathbf{P}}}
\newcommand{\sproj}{\ensuremath{\mathbf{Q}}}
\newcommand{\obj}[1]{\ensuremath{\mathcal{L}\left(#1\right)}}
\newcommand{\exemplar}{\varepsilon}
\newcommand{\exemplars}{\boldsymbol{\varepsilon}}
\newcommand{\cin}{\ensuremath{\mathcal{X}}}
\newcommand{\cinsize}{\ensuremath{n}}
\newcommand{\csim}{\ensuremath{\operatorname{sim}}}
\newcommand{\apcons}{\ensuremath{g}}
\newcommand{\apop}{\ensuremath{\operatorname{APCluster}}}
\newcommand{\sapsalth}{\ensuremath{{\lambda_{sal}}}}
\newcommand{\sapsimth}{\ensuremath{{\lambda_{sim}}}}

%%%


\newcommand{\strmDoc}{\ensuremath{\mathbf{d}}}
\newcommand{\strmDocSize}{\ensuremath{m}}
\newcommand{\strmSentSize}{\ensuremath{n}}
\newcommand{\strmSent}{\ensuremath{\mathbf{x}}}
\newcommand{\strmExtr}{\ensuremath{y}}
\newcommand{\timestamp}{\tau}
\newcommand{\senttimestamp}{\timestamp^{(x)}}
\newcommand{\doctimestamp}{\timestamp^{(d)}}
\newcommand{\systemtime}{\timestamp^{(s)}}
\newcommand{\strmupdate}{\ensuremath{\mathbf{u}}}
\newcommand{\strmUpdateSize}{\ensuremath{{n_u}}}
\newcommand{\updatetimestamp}{\timestamp^{(u)}}
\newcommand{\nuggetSize}{\ensuremath{{n_\gamma}}}
\newcommand{\strmnugget}{\gamma}
\newcommand{\nugtimestamp}{\timestamp^{(\gamma)}}
\newcommand{\updateSummary}{\ensuremath{\mathcal{U}}}
\newcommand{\strmNuggets}{\ensuremath{\mathcal{N}}}
\newcommand{\earlymatch}{\ensuremath{M}}
\newcommand{\invearlymatch}{\ensuremath{M^{-1}}}
\newcommand{\gain}{G}
\newcommand{\latency}{L}
\newcommand{\comp}{C}
...
\newcommand{\rSentGRUParams}{\ensuremath{\overrightarrow{\varphi}}}
\newcommand{\lSentGRUParams}{\ensuremath{\overleftarrow{\varphi}}}
...
\newcommand{\sentExt}{\operatorname{SentExt}}
    ...
    \newcommand{\clEncParams}{\ensuremath{\varphi_\eta}}
    \newcommand{\clDecParams}{\ensuremath{\varphi_\zeta}}
    ...
    \newcommand{\srRRNNParams}{\overrightarrow{\varphi}}
    \newcommand{\srLRNNParams}{\overleftarrow{\varphi}}
    ...
    \newcommand{\rnnextRParams}{\ensuremath{\overrightarrow{\varphi}}}
    \newcommand{\rnnextLParams}{\ensuremath{\overleftarrow{\varphi}}}
...
%    \newcommand{\rnnextLParams}{\ensuremath{\overleftarrow{\xParams}}}
    ...
    \newcommand{\stsextREncParams}{{\overrightarrow{\varphi}_\eta}}
    \newcommand{\stsextLEncParams}{{\overleftarrow{\varphi}_\eta}}
    \newcommand{\stsextRDecParams}{{\overrightarrow{\varphi}_\zeta}}
    \newcommand{\stsextLDecParams}{{\overleftarrow{\varphi}_\zeta}}
%
...
\newcommand{\category}{c}
\newcommand{\queries}{\mathcal{Q}}
\newcommand{\policy}{f}
\newcommand{\oracle}{\policy^*}
\newcommand{\Train}{\Gamma}
\newcommand{\Feat}{\phi}
\newcommand{\modelzero}{\policy_0}
\newcommand{\rolloutpolicy}{\policy^{(o)}}
\newcommand{\state}{x}
...
\newcommand{\roaseqt}{\boldsymbol{\hat{\bsals}}^{\left(t,\hat{\bsal},\rolloutpolicy\right)}}
\newcommand{\roat}{\bsal^{\left(t,\hat{\bsal},\rolloutpolicy\right)}}
\newcommand{\roaseq}[2]{\boldsymbol{\hat{\bsals}}^{\left(#1,#2,\rolloutpolicy\right)}}
\newcommand{\roa}[2]{\bsal^{\left(#1,#2,\rolloutpolicy\right)}}
