...
%allows us to more easily study issues of faithfulness and control. %In the next chapter we turned our attention to neural NLG models for
%generating natural language utterances from meaning representations, i.e.,
%generating natural language utterances from an idealized representation of the
